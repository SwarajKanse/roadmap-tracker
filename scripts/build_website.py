  ...
  <main class="w-full pt-8 sm:pt-10 pb-16 min-h-screen">
    <div class="max-w-6xl mx-auto px-6">
      <div class="flex flex-col w-full gap-7">
        ...
        <!-- 6. Wisdom & Animated Dot-Matrix Quote Component -->
        <section class="rounded-xl cockpit-glass overflow-hidden shadow-xl border border-white/5 transition-all duration-300 relative group select-none" id="quote-matrix-card">
          <!-- Ambient Backing Glow -->
          <div class="pointer-events-none absolute -right-16 -top-16 w-64 h-64 bg-primary/10 rounded-full blur-3xl -z-10 transition-opacity group-hover:opacity-100 opacity-60"></div>

          <div class="grid grid-cols-1 md:grid-cols-12 gap-6 p-6 sm:p-8 items-center min-h-[350px]">
            <!-- Left Side: Rotating Quote & Author -->
            <div class="md:col-span-7 flex flex-col justify-between h-full min-h-[250px]">
              <div>
                <!-- Top Status Header -->
                <div class="flex items-center justify-between gap-2 mb-4">
                  <div class="flex items-center gap-2">
                    <span class="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                    <span class="text-[11px] font-mono uppercase tracking-wider text-on-surface-variant font-semibold">Wisdom &bull; Daily Focus</span>
                  </div>
                  <div id="quote-status-badge" class="text-[10px] font-mono px-2 py-0.5 rounded bg-surface-container border border-outline-variant/20 text-on-surface-variant/70 transition-all">
                    AUTO 10S
                  </div>
                </div>

                <!-- Quote Text Container (Smooth Cross-Fade) -->
                <div id="quote-text-container" class="transition-all duration-500 ease-out opacity-100 transform translate-y-0">
                  <div class="text-primary/30 text-3xl font-serif leading-none select-none mb-2">&ldquo;</div>
                  <p id="quote-text" class="font-calligraphy text-2xl sm:text-3xl text-on-surface font-normal leading-snug tracking-wide break-words">
                    कर्मण्येवाधिकारस्ते मा फलेषु कदाचन।
                  </p>
                  
                  <div class="mt-4 flex flex-wrap items-center gap-3">
                    <span id="quote-author" class="font-mono text-sm sm:text-base font-bold text-primary tracking-wide">
                      Shri Krishna
                    </span>
                    <span id="quote-note" class="text-[10px] font-mono px-2.5 py-0.5 rounded-full bg-primary/10 border border-primary/25 text-primary/90 font-medium">
              ...
              <div class="pt-6 mt-4 border-t border-outline-variant/10 flex items-center justify-between gap-4">
                <div class="flex items-center gap-1.5" id="quote-dots-indicator">
                  <!-- Generated dynamically (6 dots) -->
                </div>
                <div class="flex items-center gap-1">
                  <button id="quote-prev-btn" type="button" class="w-7 h-7 rounded-lg cockpit-subglass border border-outline-variant/20 hover:border-primary/40 flex items-center justify-center text-on-surface-variant hover:text-on-surface transition-colors cursor-pointer" title="Previous Quote">
                    <span class="material-symbols-outlined text-[16px]">chevron_left</span>
                  </button>
                  <button id="quote-next-btn" type="button" class="w-7 h-7 rounded-lg cockpit-subglass border border-outline-variant/20 hover:border-primary/40 flex items-center justify-center text-on-surface-variant hover:text-on-surface transition-colors cursor-pointer" title="Next Quote">
            ...
            <!-- Right Side: Animated Dot-Matrix Canvas -->
            <div class="md:col-span-5 flex items-center justify-center relative min-h-[300px]">
